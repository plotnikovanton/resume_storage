...
public abstract class AbstractArrayStorageTest {
    ...
    @Test
    public void get() {
        Assert.assertEquals(testResume1, storage.get(UUID_1));
    }
    ...
    public void save() {
        ...
        Assert.assertEquals(testResume4, storage.get(UUID_4));
    ...
    public void update() {
        ...
        Assert.assertEquals(testResume2, storage.get(UUID_2));
    }
